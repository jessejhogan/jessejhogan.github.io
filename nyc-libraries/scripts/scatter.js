...
// chaining is done with the . s, which is similar to how %>% works in dplyr
// indentation also does not matter, this is for org purposes

// some unique js to code into my project

$(".cover").hover(
    function() {
        $(this).attr("src", "bplcentrallibrary.jpeg");
    },
    function() {
        $(this).attr("src", "centrallibrarypresent.jpg");
    }                         
);  
